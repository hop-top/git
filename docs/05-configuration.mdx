---
title: Configuration
description: Configure git-hop to your needs
---
...
```bash
export GIT_HOP_LOG_LEVEL="info"  # debug, info, warn, error
```
...
- [Workflows](/docs/06-workflows) - See configuration in action
- [Integration](/docs/07-integration) - Integrate with other tools
- [Advanced Usage](/docs/08-advanced-usage) - Deep dive into configuration
